...
class Codnitive_Productfilter_Block_Adminhtml_Catalog_Product_Grid extends Mage_Adminhtml_Block_Catalog_Product_Grid
{
...
//		if(Mage::getStoreConfig(self::CONFIG_ENABLED)) {
			...
			$attributeCodes = Mage::getStoreConfig(self::CONFIG_ATTRIBUTE_CODE);
...
//		if(Mage::getStoreConfig(self::CONFIG_ENABLED)) {
			...
			$attributeCodeConfigs = Mage::getStoreConfig(self::CONFIG_ATTRIBUTE_CODE);
			$attributeCodeConfigs = explode(',', $attributeCodeConfigs);
			foreach ($attributeCodeConfigs as $attributeCodeConfig) {
